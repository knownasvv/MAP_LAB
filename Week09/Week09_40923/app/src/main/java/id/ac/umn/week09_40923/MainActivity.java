...
import id.ac.umn.week09_40923.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mhsVM.getDaftarMahasiswa().observe(this,
                mhss -> adapter.setDaftarMahasiswa(mhss));
    ...
    public void onActivityResult(int reqCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK) {
            ...
            if(reqCode == REQUEST_TAMBAH) mhsVM.insert(mhs);
            else if(reqCode == REQUEST_EDIT) mhsVM.update(mhs);
        }
