...
RecyclerView.Adapter<MahasiswaListAdapter.MahasiswaViewHolder> {
    ...
    @NonNull
    @Override
    public MahasiswaListAdapter.MahasiswaViewHolder onCreateViewHolder(
    ...
    public void onBindViewHolder(
            @NonNull MahasiswaListAdapter.MahasiswaViewHolder holder, int position) {
        ...
        } else holder.tvNim.setText("Belum ada mahasiswa");
    }

    @Override
    public int getItemCount() {
        if(daftarMahasiswa != null) return daftarMahasiswa.size();
        else return 0;
    }
